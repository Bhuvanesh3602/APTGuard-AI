...
def _seed_actor_catalog() -> dict[str, ThreatActorProfile]:
    ...
    return {
        ...
        # ── India-specific threat actors ──────────────────────────────────────
        "SideCopy": ThreatActorProfile(
            id="SideCopy",
            name="SideCopy (APT-C-24)",
            aliases=["APT-C-24"],
            description=(
                "Pakistan-linked espionage group targeting Indian defence and government. "
                "Named for copying SideWinder's TTPs. Active since 2019. "
                "CERT-In advisory CI-2023-0012."
            ),
            sophistication_level="intermediate",
            primary_motivation="espionage",
            secondary_motivations=["intelligence collection"],
            ttps=["T1566.001", "T1204.002", "T1059.001", "T1547.001", "T1071.001", "T1105", "T1036.005", "T1027"],
            tools=["ReverseRat", "CetaRAT", "Allakore", "AsyncRAT", "njRAT"],
            targets=["indian defence", "government", "ministry of defence", "aerospace", "military"],
            confidence_score=0.82,
        ),
        "APT36": ThreatActorProfile(
            id="APT36",
            name="APT36 (Transparent Tribe)",
            aliases=["Transparent Tribe", "ProjectM", "C-Major", "PROJECTM"],
            description=(
                "Pakistan-linked group primarily targeting Indian military and education. "
                "Known for Crimson RAT campaigns against CBSE and armed forces. "
                "CERT-In advisory CI-2024-0018."
            ),
            sophistication_level="intermediate",
            primary_motivation="espionage",
            secondary_motivations=["data theft"],
            ttps=["T1566.001", "T1566.002", "T1059.001", "T1071.001", "T1105", "T1547.001", "T1074.001", "T1041"],
            tools=["Crimson RAT", "ObliqueRAT", "ElectroRAT", "Capra", "AndroRAT"],
            targets=["education", "government", "military", "healthcare", "cbse", "aiims"],
            confidence_score=0.85,
        ),
        "Lazarus_India": ThreatActorProfile(
            id="Lazarus_India",
            name="Lazarus Group (India Operations)",
            aliases=["Hidden Cobra", "ZINC", "Labyrinth Chollima"],
            description=(
                "DPRK-linked group with documented India operations targeting healthcare "
                "and financial sector. Deployed WannaCry ransomware affecting Indian hospitals. "
                "CERT-In advisory CI-2022-0001."
            ),
            sophistication_level="advanced",
            primary_motivation="financial gain",
            secondary_motivations=["espionage", "disruption"],
            ttps=["T1059.001", "T1059.003", "T1071.001", "T1041", "T1486", "T1490", "T1489", "T1070.004"],
            tools=["WannaCry", "VHD Ransomware", "MagicRAT", "BLINDINGCAN", "HOPLIGHT"],
            targets=["healthcare", "financial institutions", "cryptocurrency", "critical infrastructure"],
            confidence_score=0.83,
        ),
        "Volt_Typhoon": ThreatActorProfile(
            id="Volt_Typhoon",
            name="Volt Typhoon (Bronze Silhouette)",
            aliases=["Bronze Silhouette", "Dev-0391", "Vanguard Panda"],
            description=(
                "China-linked group pre-positioning in critical infrastructure for potential "
                "future disruption. Targets OT/ICS environments including power grids and telecom. "
                "Living-off-the-land tradecraft makes detection extremely difficult. "
                "NCIIPC advisory NCIIPC-2023-009."
            ),
            sophistication_level="expert",
            primary_motivation="pre-positioning",
            secondary_motivations=["espionage", "disruption"],
            ttps=["T1190", "T1133", "T1078", "T1021.001", "T1016", "T1049", "T1082", "T1003.001", "T1048.003"],
            tools=["FRP", "Impacket", "WMI", "living-off-the-land"],
            targets=["power grid", "telecom", "water", "critical infrastructure", "ot systems", "energy"],
            confidence_score=0.80,
        ),
    }
